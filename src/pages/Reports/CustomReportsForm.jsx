...
class CustomReportsForm extends Component {
	...
	state = {
		...
		city: '' ,
		category: '',
		cluster: this.props.data.user.cluster ? [{label: this.props.data.user.cluster.name,value: this.props.data.user.cluster.id}] : [],
		zone:'',
		type: this.props.data.user.type ? [{label: this.props.data.user.type.name,value: this.props.data.user.type.id}] : [],
		table_type: '',
		campaign: ''
	}
	render() {
			...
			<div className="col-4">
				...
				<div className="radio" style={{"marginTop":5}}>
					<label className="mr-4">
						<input type="radio" value="ad_spots" checked={this.state.selectedOption === 'ad_spots'} onChange={this.handleOptionChange} /> Ad Spots
					</label>
					<label>
						<input type="radio" value="tasks" checked={this.state.selectedOption === 'tasks'} onChange={this.handleOptionChange}/> Tasks
					</label>
				</div>
			</div>
			<div className="col-4">
