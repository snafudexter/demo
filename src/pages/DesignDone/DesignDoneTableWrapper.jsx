...
import DesignDoneToolbar from './DesignDoneToolbar';
...
class DesignDoneTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns : [
			{
  ...
  renderTasksTable = () => {
    ...
    return (
      ...
      <h2 className="content-heading">
          Designing Section <small>List of all Designing Done Tasks</small>
...
export default compose(graphql(ALL_DESIGNING_DONE, {
  props: ({data}) => {
    if (!data.allTasks) 
  ...
  options: {
    variables: {
      statusArr: ['DESIGNINGDONE']
    },
    fetchPolicy: 'cache-and-network'
  }
}),)(DesignDoneTableWrapper);

DesignDoneTableWrapper.propTypes = {};