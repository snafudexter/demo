...
import PrintingDoneToolbar from './PrintingDoneToolBar';
...
class PrintingDoneTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns : [
			{
...
export default compose(
  ...
  options: {
    variables: {
      statusArr: ['PRINTINGDONE']
    },
    fetchPolicy: 'cache-and-network'
  }
}),)(PrintingDoneTableWrapper);

PrintingDoneTableWrapper.propTypes = {};