...
class RecceAssignedTasksToolbar extends Component {
  state={
    loading:false,
  }
  handleAssignRecce = () => {
    ...
    return (
      <div className="float-right">
        ...
        <button
          ...
          className="btn btn-sm btn-rounded btn-warning float-right"
          onClick={this.handleAssignRecce}>
          <i className="fa fa-check mr-1"/>
          
          {this.state.loading?"Loading..":"Re Assign Recce"}
        </button>
...
RecceAssignedTasksToolbar.propTypes = {};