...
import RecceAssignedTasksToolbar from './RecceAssignedTasksToolbar';
...
class RecceAssignedTasksTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns : [
      {
...
}),)(RecceAssignedTasksTableWrapper);

RecceAssignedTasksTableWrapper.propTypes = {};