...
import RejectedTasksToolbar from './RejectedTasksToolbar';
...
class RejectedTasksTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns : [
			{
    ...
    return (
      <div>
        <h2 className="content-heading">
          Rejected Tasks <small>List of all Rejected Tasks</small>
          <RejectedTasksToolbar
...
export default compose(graphql(ALL_APPROVAL_TASKS, {
  props: ({data}) => {
    if (!data.allTasks) 
...
}),)(RejectedTasksTableWrapper);

RejectedTasksTableWrapper.propTypes = {};