...
class RejectedTasksToolbar extends Component {
...
`;
export default compose(graphql(BAJAJ_REVIEW, {name: 'bajajReview'}) )(RejectedTasksToolbar);

RejectedTasksToolbar.propTypes = {};