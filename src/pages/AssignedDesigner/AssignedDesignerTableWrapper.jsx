...
import AssignedDesignerToolbar from './AssignedDesignerToolbar';
...
class AssignedDesignerTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns : [
      {
    ...
    return (
      <div>
        <h2 className="content-heading">
          Assigned Designers Tasks<small>List of all Tasks Assigned to designers</small>
          <AssignedDesignerToolbar
...
export default compose(graphql(ALL_APPROVED_TASKS, {
  props: ({data}) => {
    if (!data.allTasks) 
...
}),)(AssignedDesignerTableWrapper);

AssignedDesignerTableWrapper.propTypes = {};