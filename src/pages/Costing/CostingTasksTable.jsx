...
class CostingTasksTable extends Component {
	componentWillReceiveProps(nextProps)
	{
		this.setState({rows: (nextProps.display)?sanitizeFilterTasksObject(nextProps.tasks, nextProps.display):sanitizeTasksObject(nextProps.tasks, this.props.openModalCallback)})
	}
	state = {
		filters: this.props.filter,
		rows: sanitizeTasksObject(this.props.tasks, this.props.openModalCallback),
		selectedIndexes: [],
		tableHeight: "300px",
	};
	getRows = () => {
...
export default CostingTasksTable;
