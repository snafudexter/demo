...
import ApprovalSentTasksToolbar from './ApprovalSentTasksToolbar';
...
class ApprovalSentTasksTableWrapper extends Component {
  state = {
    selectedTasks: [],
    columns: [
      {
    ...
    return (
      <div>
        <h2 className="content-heading">
          Approvals
          <small>Review and approve tasks below</small>
          <ApprovalSentTasksToolbar
...
ApprovalSentTasksTableWrapper.propTypes = {};
