...
class AdSpotsList extends Component {
        ...
        .map((adSpot, key) => {
          return (
            <AdSpotItem
              ...
              language={adSpot.language ? adSpot.language : ""}
              media={adSpot.media ? adSpot.media : ""}
              remarks={adSpot.remarks? adSpot.remarks: "" }
              category={adSpot.category ? adSpot.category : ""}
