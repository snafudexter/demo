...
class InstallationCert extends Component {
  state={
    imageId: '',
    imageUrl: this.props.installCertImage ? this.props.installCertImage.url : '',
    imageLoading: false
  }
  uploadFile(event) {
    this.setState({
...
const CERT_IMAGE_MUTATION=gql`
  mutation addInstallTaskCert($taskId:ID!,$imageId:ID!) {
    addInstallTaskCert(taskId:$taskId,imageId:$imageId) {
      id
    }
  }
`;

export default compose((graphql(CERT_IMAGE_MUTATION,{name:"addTaskCert"})))(InstallationCert)
